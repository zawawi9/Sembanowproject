...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        txt.addFocusListener(new FocusAdapter() {
            ...
            public void focusGained(FocusEvent fe) {
                border.setColor(new Color(0, 128, 128)); // Darker teal when focused
            }

            @Override
            public void focusLost(FocusEvent fe) {
                border.setColor(new Color(0, 128, 128)); // Consistent teal when not focused
            }
        });
    ...
    private class Border extends EmptyBorder {
        ...
        private Color focusColor = new Color(0, 128, 128); // Teal when focused
        private Color color = new Color(0, 128, 128); // Teal when not focused
        private int roundness = 10; // Adjust roundness of corners
        ...
        public void paintBorder(Component cmpnt, Graphics grphcs, int x, int y, int width, int height) {
            ...
            // Adjusted to match JTextField style with proper offsets and reduced size
            int round = roundness;
