 ...
 * @author Fitrah
 */
public class IncorrectResetPassword extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public IncorrectResetPassword(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Username atau NIK salah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IncorrectResetPassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IncorrectResetPassword dialog = new IncorrectResetPassword(new javax.swing.JFrame(), true);
