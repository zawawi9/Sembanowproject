 ...
 * @author Fitrah
 */
public class DataKosong1 extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public DataKosong1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataKosong1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataKosong1 dialog = new DataKosong1(new javax.swing.JFrame(), true);
