 ...
 * @author Fitrah
 */
public class TipeOnly extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public TipeOnly(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih tipe pelanggan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipeOnly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TipeOnly dialog = new TipeOnly(new javax.swing.JFrame(), true);
