 ...
 * @author Fitrah
 */
public class DataAdaRFID extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public DataAdaRFID(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("RFID telah digunakan data lain");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataAdaRFID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataAdaRFID dialog = new DataAdaRFID(new javax.swing.JFrame(), true);
