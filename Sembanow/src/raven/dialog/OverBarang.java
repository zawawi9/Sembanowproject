 ...
 * @author Fitrah
 */
public class OverBarang extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public OverBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
public void fadeOut() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Jumlah barang yang dibuang melebihi jumlah stok");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OverBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                OverBarang dialog = new OverBarang(new javax.swing.JFrame(), true);
