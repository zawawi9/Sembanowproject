 ...
 * @author Fitrah
 */
public class SesuaiFormat extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public SesuaiFormat(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Silahkan isi sesuai dengan format");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SesuaiFormat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SesuaiFormat dialog = new SesuaiFormat(new javax.swing.JFrame(), true);
