 ...
 * @author Fitrah
 */
public class PilihTanggal extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public PilihTanggal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Silahkan pilih tanggal terlebih dahulu");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihTanggal dialog = new PilihTanggal(new javax.swing.JFrame(), true);
