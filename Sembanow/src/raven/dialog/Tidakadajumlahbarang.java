 ...
 * @author Fitrah
 */
public class Tidakadajumlahbarang extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public Tidakadajumlahbarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
public void fadeOut() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tidak ada jumlah barang yang dibuang");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tidakadajumlahbarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Tidakadajumlahbarang dialog = new Tidakadajumlahbarang(new javax.swing.JFrame(), true);
