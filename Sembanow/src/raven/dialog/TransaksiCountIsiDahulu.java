 ...
 * @author Fitrah
 */
public class TransaksiCountIsiDahulu extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public TransaksiCountIsiDahulu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Isi data transaksi terlebih dahulu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransaksiCountIsiDahulu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TransaksiCountIsiDahulu dialog = new TransaksiCountIsiDahulu(new javax.swing.JFrame(), true);
