 ...
 * @author Fitrah
 */
public class JabatanOnly extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public JabatanOnly(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Jabatan hanya tersedia admin dan karyawan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JabatanOnly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JabatanOnly dialog = new JabatanOnly(new javax.swing.JFrame(), true);
