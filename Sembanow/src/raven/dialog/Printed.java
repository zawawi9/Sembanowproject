 ...
 * @author Fitrah
 */
public class Printed extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public Printed(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cetak Berhasil");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Printed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Printed dialog = new Printed(new javax.swing.JFrame(), true);
