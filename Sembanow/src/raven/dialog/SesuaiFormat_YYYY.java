 ...
 * @author Fitrah
 */
public class SesuaiFormat_YYYY extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public SesuaiFormat_YYYY(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tahun sesuai format. (YYYY)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SesuaiFormat_YYYY.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SesuaiFormat_YYYY dialog = new SesuaiFormat_YYYY(new javax.swing.JFrame(), true);
