 ...
 * @author Fitrah
 */
public class Updated extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public Updated(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
public void fadeOut() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data diperbarui");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Updated dialog = new Updated(new javax.swing.JFrame(), true);
