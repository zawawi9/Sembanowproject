 ...
 * @author Fitrah
 */
public class PilihSalary extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public PilihSalary(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Salary tidak boleh kosong");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihSalary.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihSalary dialog = new PilihSalary(new javax.swing.JFrame(), true);
