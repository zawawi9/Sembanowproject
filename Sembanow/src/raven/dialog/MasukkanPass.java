 ...
 * @author Fitrah
 */
public class MasukkanPass extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public MasukkanPass(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
public void fadeOut() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasukkanPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MasukkanPass dialog = new MasukkanPass(new javax.swing.JFrame(), true);
