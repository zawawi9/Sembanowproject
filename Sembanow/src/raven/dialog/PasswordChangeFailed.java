 ...
 * @author Fitrah
 */
public class PasswordChangeFailed extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public PasswordChangeFailed(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Password gagal diubah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswordChangeFailed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PasswordChangeFailed dialog = new PasswordChangeFailed(new javax.swing.JFrame(), true);
