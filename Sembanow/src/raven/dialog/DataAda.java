 ...
 * @author Fitrah
 */
public class DataAda extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public DataAda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data sudah ada sebelumnya");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataAda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataAda dialog = new DataAda(new javax.swing.JFrame(), true);
