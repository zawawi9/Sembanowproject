 ...
 * @author Fitrah
 */
public class JumlahBarcode extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public JumlahBarcode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Silahkan masukkan jumlah yang diinginkan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JumlahBarcode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JumlahBarcode dialog = new JumlahBarcode(new javax.swing.JFrame(), true);
