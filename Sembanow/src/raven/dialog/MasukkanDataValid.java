 ...
 * @author Fitrah
 */
public class MasukkanDataValid extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public MasukkanDataValid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
public void fadeOut() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ID dan jumlah harus berupa angka");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasukkanDataValid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MasukkanDataValid dialog = new MasukkanDataValid(new javax.swing.JFrame(), true);
