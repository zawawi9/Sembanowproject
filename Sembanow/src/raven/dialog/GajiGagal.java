 ...
 * @author Fitrah
 */
public class GajiGagal extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public GajiGagal(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tidak dapat menggaji karyawan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GajiGagal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GajiGagal dialog = new GajiGagal(new javax.swing.JFrame(), true);
