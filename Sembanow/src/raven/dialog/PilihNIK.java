 ...
 * @author Fitrah
 */
public class PilihNIK extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public PilihNIK(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NIK tidak boleh kosong");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihNIK.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihNIK dialog = new PilihNIK(new javax.swing.JFrame(), true);
