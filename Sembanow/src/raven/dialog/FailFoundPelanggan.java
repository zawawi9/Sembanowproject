 ...
 * @author Fitrah
 */
public class FailFoundPelanggan extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public FailFoundPelanggan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gagal mencari produk");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailFoundPelanggan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailFoundPelanggan dialog = new FailFoundPelanggan(new javax.swing.JFrame(), true);
