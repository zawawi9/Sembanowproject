 ...
 * @author Fitrah
 */
public class ProdukTidakDitemukan extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public ProdukTidakDitemukan(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Produk tidak ditemukan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdukTidakDitemukan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProdukTidakDitemukan dialog = new ProdukTidakDitemukan(new javax.swing.JFrame(), true);
