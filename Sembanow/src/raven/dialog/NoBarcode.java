 ...
 * @author Fitrah
 */
public class NoBarcode extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public NoBarcode(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gambar barcode tidak tersedia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoBarcode.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NoBarcode dialog = new NoBarcode(new javax.swing.JFrame(), true);
