 ...
 * @author Fitrah
 */
public class Pilihsalahsatu extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public Pilihsalahsatu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pilihsalahsatu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pilihsalahsatu dialog = new Pilihsalahsatu(new javax.swing.JFrame(), true);
