 ...
 * @author Fitrah
 */
public class PilihRole extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public PilihRole(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Role tidak boleh kosong");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihRole.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PilihRole dialog = new PilihRole(new javax.swing.JFrame(), true);
