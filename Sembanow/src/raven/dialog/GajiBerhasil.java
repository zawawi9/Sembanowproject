 ...
 * @author Fitrah
 */
public class GajiBerhasil extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public GajiBerhasil(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Karyawan Telah Digaji");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswordChanged.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PasswordChanged dialog = new PasswordChanged(new javax.swing.JFrame(), true);
