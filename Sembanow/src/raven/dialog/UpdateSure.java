 ...
 * @author Fitrah
 */
public class UpdateSure extends javax.swing.JDialog {
    ...
    public UpdateSure(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Barang yang dicatat \"hilang\",");
        ...
        jLabel2.setText("akan tercatat sebagai \"aman\"?");
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateSure.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateSure dialog = new UpdateSure(new javax.swing.JFrame(), true);
