 ...
 * @author Fitrah
 */
public class DataKosong extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public DataKosong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data tidak ditemukan");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DataKosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DataKosong dialog = new DataKosong(new javax.swing.JFrame(), true);
