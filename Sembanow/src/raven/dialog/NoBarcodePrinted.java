 ...
 * @author Fitrah
 */
public class NoBarcodePrinted extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public NoBarcodePrinted(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Barcode tidak dapat dicetak");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NoBarcodePrinted.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NoBarcodePrinted dialog = new NoBarcodePrinted(new javax.swing.JFrame(), true);
