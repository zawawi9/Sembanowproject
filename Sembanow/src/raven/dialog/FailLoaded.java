 ...
 * @author Fitrah
 */
public class FailLoaded extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public FailLoaded(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailLoaded.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailLoaded dialog = new FailLoaded(new javax.swing.JFrame(), true);
