 ...
 * @author Fitrah
 */
public class MasukkanLogin extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public MasukkanLogin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MasukkanLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MasukkanLogin dialog = new MasukkanLogin(new javax.swing.JFrame(), true);
