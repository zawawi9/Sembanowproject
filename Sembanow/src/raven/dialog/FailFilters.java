 ...
 * @author Fitrah
 */
public class FailFilters extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public FailFilters(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gagal memfilter data");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailFilters.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailFilters dialog = new FailFilters(new javax.swing.JFrame(), true);
