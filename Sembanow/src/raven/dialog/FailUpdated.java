 ...
 * @author Fitrah
 */
public class FailUpdated extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public FailUpdated(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gagal memperbarui data");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailUpdated.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailUpdated dialog = new FailUpdated(new javax.swing.JFrame(), true);
