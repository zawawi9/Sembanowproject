 ...
 * @author Fitrah
 */
public class SesuaiFormat_YYYYMMDD extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public SesuaiFormat_YYYYMMDD(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Tanggal sesuai format. (YYYY-MM-DD)");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SesuaiFormat_YYYYMMDD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SesuaiFormat_YYYYMMDD dialog = new SesuaiFormat_YYYYMMDD(new javax.swing.JFrame(), true);
