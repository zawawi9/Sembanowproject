 ...
 * @author Fitrah
 */
public class Pilihdahulu extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public Pilihdahulu(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pilih data terlebih dahulu");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pilihdahulu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Pilihdahulu dialog = new Pilihdahulu(new javax.swing.JFrame(), true);
