 ...
 * @author Fitrah
 */
public class FailSearchProduk extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public FailSearchProduk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailSearchProduk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailSearchProduk dialog = new FailSearchProduk(new javax.swing.JFrame(), true);
