 ...
 * @author Fitrah
 */
public class TransaksiCountKosong extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public TransaksiCountKosong(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Jumlah transaksi belum ada");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransaksiCountKosong.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TransaksiCountKosong dialog = new TransaksiCountKosong(new javax.swing.JFrame(), true);
