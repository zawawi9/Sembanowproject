 ...
 * @author Fitrah
 */
public class RFIDTidakterdaftar extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public RFIDTidakterdaftar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RFIDTidakterdaftar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RFIDTidakterdaftar dialog = new RFIDTidakterdaftar(new javax.swing.JFrame(), true);
