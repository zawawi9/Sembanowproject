 ...
 * @author Fitrah
 */
public class ProdukAda extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public ProdukAda(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Produk sudah ada sebelumnya");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdukAda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProdukAda dialog = new ProdukAda(new javax.swing.JFrame(), true);
