 ...
 * @author Fitrah
 */
public class PrintFailed extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public PrintFailed(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gagal mencetak");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintFailed.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PrintFailed dialog = new PrintFailed(new javax.swing.JFrame(), true);
