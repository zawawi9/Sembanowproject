 ...
 * @author Fitrah
 */
public class NegatifBarang extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public NegatifBarang(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
...
public void fadeOut() {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Jumlah barang yang dibuang tidak boleh negatif");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NegatifBarang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                NegatifBarang dialog = new NegatifBarang(new javax.swing.JFrame(), true);
