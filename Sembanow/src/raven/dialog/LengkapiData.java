 ...
 * @author Fitrah
 */
public class LengkapiData extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public LengkapiData(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("SIlahkan isi data tersebut dengan lengkap");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LengkapiData.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LengkapiData dialog = new LengkapiData(new javax.swing.JFrame(), true);
