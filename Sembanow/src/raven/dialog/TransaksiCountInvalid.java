 ...
 * @author Fitrah
 */
public class TransaksiCountInvalid extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public TransaksiCountInvalid(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Jumlah yang dibayar harus berupa angka");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TransaksiCountInvalid.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TransaksiCountInvalid dialog = new TransaksiCountInvalid(new javax.swing.JFrame(), true);
