 ...
 * @author Fitrah
 */
public class FailCount extends javax.swing.JDialog {

    /**
     * Creates new form Delete
     */
    public FailCount(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        setUndecorated(true);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gagal menghitung jumlah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailCount.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailCount dialog = new FailCount(new javax.swing.JFrame(), true);
